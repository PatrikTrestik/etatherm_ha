...
> **Deprecated — last release.** This integration uses the legacy Etatherm protocol and will not receive further features. Please migrate to **[Etatherm Modbus](https://github.com/PatrikTrestik/homeassistant_etatherm_modbus)** (Modbus TCP, UI config flow).
...
1. Install [Etatherm Modbus](https://github.com/PatrikTrestik/homeassistant_etatherm_modbus) from HACS.
